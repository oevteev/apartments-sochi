...
const BookingForm = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const message = `Запрос информации по аренде апартаментов в Сочи от ${name.trim()}, телефон ${phone}, пожалуйста, свяжитесь со мной для уточнения деталей. С уважением, ${name.trim()}`;
