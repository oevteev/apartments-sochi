...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Мы принимаем оплату наличными, банковскими картами и переводом на расчётный счёт. Предоплата составляет 20% от стоимости проживания.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "К сожалению, у нас не разрешено размещение с животными. Надеемся на ваше понимание!",
      },
    },
    {
      "@type": "Question",
