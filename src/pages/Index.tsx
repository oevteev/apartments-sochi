...
const Index = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Посуточная аренда квартир в Сочи с видом на море"
        description="Аренда дизайнерских квартир посуточно в Сочи у моря. Прямое бронирование без комиссий. Удаленное заселение, наличе парковки, поддержка 24/7."
      />
      <StructuredData />
      {/* Hero Section */}
      <section
