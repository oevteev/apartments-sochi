  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Для бронирования требуется внести залог в размере 6 000 рублей. Это страховой депозит на случай порчи имущества. Мы полностью вернем вам эти деньги в день выезда, если в апартаментах всё будет в целости и сохранности.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Кухня с посудой; WI-FI; Техника (современный 55-дюймовый Smart-телевизор с возможностью выхода в интернет, кондиционер, стиральная машина, бойлер, фен, утюг/отпариватель); Постельное белье; Полотенца (кроме пляжных); Средства гигиены",
      },
      {
        question: "Где расположены апартаменты?",
        answer:
          "Апартаменты расположены в центральном районе Сочи — «Приморье». Это самое популярное и оживлённое место города в шаговой доступности от моря.",
      },
      {
        question: "Как далеко находятся апартаменты от моря?",
        answer:
          "Подавляющее большинство апартаментов расположено в радиусе 700-800 метров от моря, что соответствует 10 минутам неспешной ходьбы.",
      },
      {
        question: "Заселение с детьми разрешено?",
        answer:
          "Да, конечно! Мы с радостью принимаем гостей с детьми от 12 лет. Для детей младшего возраста, к сожалению, инфраструктура наших апартаментов не предусмотрена.",
      },
      {
        question: "Можно ли с животными?",
        answer: "К сожалению, у нас не разрешено размещение с животными. Надеемся на ваше понимание!",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Да, для вашего автомобиля будет предоставлено бесплатное парковочное место на прилегающей к дому охраняемой территории. Это одно из преимуществ проживания у нас.",
      },
      {
        question: "Есть ли скидки на длительное проживание?",
        answer: "Да, конечно! Предоставляем скидку 10% при проживании от 10 дней и 15% — от 14 дней.",
      },
      {
