    ...
    questions: [
      {
        ...
        answer:
          "Кухня с посудой; WI-FI; Техника (телевизор, кондиционер, стиральная машина, бойлер, фен, утюг/отпариватель); Постельное белье; Полотенца (кроме пляжных); Средства гигиены",
      },
      {
