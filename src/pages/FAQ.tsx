    ...
    questions: [
      {
        ...
        answer:
          "Для заселения необходим паспорт РФ. Для иностранных граждан - загранпаспорт и миграционная карта.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Да, если апартамент свободен и не занят другими гостями. Обязательно уточняйте заранее.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Да, возможна длительная аренда сроком до 11 месяцев. Цену и сроки аренды уточняйте у администратора.",
      },
    ],
  },
];
