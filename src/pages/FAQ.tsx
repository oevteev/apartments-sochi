    ...
    questions: [
      {
        ...
        answer:
          "Кухня с посудой; WI-FI; Техника (Smart TV 55 дюймов, кондиционер, стиральная машина, бойлер, фен, утюг/отпариватель); Постельное белье; Полотенца (кроме пляжных); Средства гигиены",
      },
      {
